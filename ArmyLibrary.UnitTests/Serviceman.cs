...
namespace ArmyLibrary
{
    public class Serviceman
    {
        ...
        public string GetInfo()
        {
            ...
            return $"{Name} {Surname}. Номер билета {NumMillitaryTicket} Номер военной части {NumMillitaryTicket} Звание {Rank} Дата поступления на службу {DateTime} Тип службы {TypeOfService}.";
        }
